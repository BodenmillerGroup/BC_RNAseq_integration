...
prop.PDCD1 <- Cell.nr.PDCD1/Cell.nr.total
...
# Proportion out of all TNK cells
...
```{r}
tab$IEassigned <- ifelse(!(is.na(tab$IE)), tab$IE, ifelse(tab$prop.Tfh.CD8exh > 0.15, "IE1", "IE2"))
```
